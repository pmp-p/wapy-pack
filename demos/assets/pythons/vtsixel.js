...
},{"./Strings":14,"./common/Lifecycle":20,"./core/Platform":23,"./ui/Lifecycle":52,"./ui/RenderDebouncer":55}],2:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var Buffer = (function () {
    ...
    Buffer.prototype.addMarker = function (y) {
        ...
        marker.register(this.lines.addDisposableListener('move', function (event) {
...
var ElementInset = (function (_super) {
    __extends(ElementInset, _super);
    function ElementInset(_terminal, element) {
        var _this = _super.call(this) || this;
        _this._terminal = _terminal;
    ...
    ElementInset.prototype.put = function (line, column, owner) {
        var _this = this;
        if (owner === void 0) { owner = this._terminal.buffer.lines.get(line); }
        var cheight = this._terminal.renderer.dimensions.actualCellHeight;
        var cwidth = this._terminal.renderer.dimensions.actualCellWidth;
        ...
        this.register(this._terminal.buffer.lines.addDisposableListener('move', function (event) {
            if (line >= event.start && (event.end === undefined || line < event.end)) {
                ...
                if (line < event.start ||
                    ...
                    _this.wrapper.style.top = (line * cheight) + 'px';
                }
            }
        }));
        this.owner = owner;
    ...
    ElementInset.prototype.updatePosition = function (height, width) {
        if (width === void 0) { width = -1; }
        var terminal = this._terminal;
        var cheight = terminal.renderer.dimensions.actualCellHeight;
        var ydelta = Math.ceil(height / cheight);
        if (true || width <= 0) {
            terminal.buffer.x = 0;
        }
        else {
    ...
    ElementInset.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
...
exports.ElementInset = ElementInset;
...
Object.defineProperty(exports, "__esModule", { value: true });
var sixel_image_1 = require("./sixel-image");
...
var SIXEL = (function () {
    function SIXEL(_terminal) {
        this._terminal = _terminal;
        this._data = new Uint32Array(0);
    }
    SIXEL.prototype.hook = function (collect, params, flag) {
        this._data = new Uint32Array(0);
    };
    SIXEL.prototype.put = function (data, start, end) {
        this._data = TypedArrayUtils_1.concat(this._data, data.subarray(start, end));
    };
    SIXEL.prototype.unhook = function () {
        var buffer = this._terminal.buffer;
        var six = new sixel_image_1.SixelImage();
        ...
        var inset = new Buffer_1.ElementInset(this._terminal, image);
        var celly = buffer.y + buffer.ybase;
...
var InputHandler = (function (_super) {
    ...
    function InputHandler(_terminal, _parser) {
        ...
        _this._parser.setOscHandler(72, function (data) {
            function scrub(htmlText) {
                return htmlText;
            }
            var terminal = _this._terminal;
            var buffer = _this._terminal.buffer;
            var inset = new Buffer_1.ElementInset(_this._terminal, null);
        ...
        _this._parser.setDcsHandler('q', new SIXEL(_this._terminal));
        return _this;
    }
...
},{"./Buffer":2,"./CharWidth":6,"./EscapeSequenceParser":8,"./common/Lifecycle":20,"./common/TypedArrayUtils":21,"./common/data/EscapeSequences":22,"./core/data/Charsets":24,"./core/input/TextDecoder":26,"./sixel-image":49}],10:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./Buffer":2,"./CharWidth":6,"./common/EventEmitter":19,"./ui/MouseZoneManager":54}],11:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var SelectionManager = (function (_super) {
    ...
    SelectionManager.prototype._initListeners = function () {
        ...
        this._moveListener = function (event) { return _this._onMove(event); };
    ...
    SelectionManager.prototype._onMove = function (event) {
        var needsRefresh = this._model.onMove(event);
        if (needsRefresh) {
            this.refresh();
        }
    };
...
},{"./Buffer":2,"./SelectionModel":12,"./common/EventEmitter":19,"./core/Platform":23,"./handlers/AltClickHandler":27,"./ui/MouseHelper":53}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var SelectionModel = (function () {
    ...
    SelectionModel.prototype.onMove = function (event) {
...
var Terminal = (function (_super) {
    ...
    Terminal.prototype._setup = function () {
        ...
        this.buffers.on('activate', function (arg) {
            _this._viewportScrollArea.style.display = arg.alt ? 'none' : '';
        });
...
},{"./common/Lifecycle":20,"./ui/Lifecycle":52}],17:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../common/EventEmitter":19,"../renderer/CharacterJoinerRegistry":30,"../ui/RenderDebouncer":55,"../ui/ScreenDprMonitor":56,"./ColorManager":31,"./CursorRenderLayer":32,"./LinkRenderLayer":34,"./SelectionRenderLayer":36,"./TextRenderLayer":37}],36:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../../common/EventEmitter":19,"../../ui/RenderDebouncer":55,"../ColorManager":31,"../atlas/Types":46,"./DomRendererRowFactory":48}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Buffer_1 = require("../../Buffer");
var Types_1 = require("../atlas/Types");
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var BIG_ENDIAN = new Uint8Array(new Uint32Array([0xFF000000]).buffer)[0] === 0xFF;
function toRGBA8888(r, g, b, a) {
    return (BIG_ENDIAN)
...
var DEFAULT_BACKGROUND = toRGBA8888(0, 0, 0, 255);
...
function hlsToRgb(h, l, s) {
    ...
    return (BIG_ENDIAN)
        ? Math.round(r * 255) << 24 | Math.round(g * 255) << 16 | Math.round(b * 255) << 8 | 0xFF
        : 0xFF000000 | Math.round(b * 255) << 16 | Math.round(g * 255) << 8 | Math.round(r * 255);
}
function normalizeRGB(r, g, b) {
    return (BIG_ENDIAN)
        ? Math.round(r / 100 * 255) << 24 | Math.round(g / 100 * 255) << 16 | Math.round(b / 100 * 255) << 8 | 0xFF
        : 0xFF000000 | Math.round(b / 100 * 255) << 16 | Math.round(g / 100 * 255) << 8 | Math.round(r / 100 * 255);
}
function normalizeHLS(h, l, s) {
    return hlsToRgb((h + 240) / 360 - 1, l / 100, s / 100);
}
var SixelBand = (function () {
    function SixelBand(length) {
        if (length === void 0) { length = 4; }
        this._cursor = 0;
        this.width = 0;
        this.data = new Uint32Array(length * 6);
    }
    SixelBand.prototype.addSixel = function (code, color) {
        var pos = this._cursor * 6;
        if (pos >= this.data.length) {
            var data = new Uint32Array(this.data.length * 2);
            data.set(this.data);
            this.data = data;
        }
        code -= 63;
    ...
    SixelBand.prototype.addSixels = function (data, start, end, color) {
        for (var pos = start; pos < end; ++pos) {
            this.addSixel(data[pos], color);
        }
    };
    SixelBand.prototype.CR = function () {
        this._cursor = 0;
    };
    SixelBand.prototype.copyPixelRow = function (target, offset, row, start, length) {
        var end = Math.min(this.width, start + length);
        var pixel = 0;
        for (var i = start; i < end; ++i) {
...
exports.TransitionTable = TransitionTable;
var SIXEL_TABLE = (function () {
    var table = new TransitionTable(1024);
    var states = r(0, 3 + 1);
    var state;
    for (state in states) {
...
var SixelImage = (function () {
    function SixelImage(fillColor) {
        if (fillColor === void 0) { fillColor = DEFAULT_BACKGROUND; }
    ...
    Object.defineProperty(SixelImage.prototype, "height", {
        get: function () {
    ...
    Object.defineProperty(SixelImage.prototype, "width", {
        get: function () {
            return this._width || Math.max.apply(null, this._bands.map(function (el) { return el.width; })) | 0;
        },
        enumerable: true,
        configurable: true
    });
    SixelImage.prototype.writeString = function (data, start, end) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = data.length; }
    ...
    SixelImage.prototype.write = function (data, start, end) {
        if (start === void 0) { start = 0; }
        if (end === void 0) { end = data.length; }
        var currentState = this._currentState;
        var dataStart = -1;
        var band = this._currentBand;
        var color = this._currentColor;
        var params = this._params;
        for (var i = start; i < end; ++i) {
            var code = data[i];
            var transition = SIXEL_TABLE.table[currentState << 8 | (code < 0x7F ? code : 0xFF)];
            switch (transition >> 4) {
                case 1:
                    dataStart = (~dataStart) ? dataStart : i;
                    break;
                case 0:
                    if (currentState === 0 && ~dataStart) {
                        if (!band) {
    ...
    SixelImage.prototype.toImageData = function (target, width, height, dx, dy, sx, sy, swidth, sheight, fillColor) {
        if (dx === void 0) { dx = 0; }
        if (dy === void 0) { dy = 0; }
        if (sx === void 0) { sx = 0; }
        if (sy === void 0) { sy = 0; }
        if (swidth === void 0) { swidth = this.width; }
        if (sheight === void 0) { sheight = this.height; }
        if (fillColor === void 0) { fillColor = this.fillColor; }
        ...
        var target32 = new Uint32Array(target.buffer);
        var p = sy % 6;
        var bandIdx = (sy / 6) | 0;
        var i = 0;
        while (bandIdx < this._bands.length && i < sheight) {
            var offset = (dy + i) * width + dx;
            if (fillColor) {
                var end = offset + swidth;
...
},{"../common/EventEmitter":19}],51:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../common/Lifecycle":20,"./Lifecycle":52}],55:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../common/Lifecycle":20}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Terminal_1 = require("./public/Terminal");
module.exports = Terminal_1.Terminal;

},{"./public/Terminal":28}]},{},[57])(57)
});
